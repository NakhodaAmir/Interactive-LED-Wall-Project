...
public class TestTask0 {
    ...
    public void testParseLevelSmall() {
        SampleGame game = new SampleGame();
        Level level = LevelParser.parseLevel(game, "data/levels/testing/medium.csv");
        level.update(0); // To finish adding static/dynamic objects
        // Level properties
        assertNotNull(level);
    ...
    public void testParseLevelBig() {
        SampleGame game = new SampleGame();
        Level level = LevelParser.parseLevel(game, "data/levels/testing/large.csv");
        level.update(0); // To finish adding static/dynamic objects
        // Level properties
        assertNotNull(level);
    ...
    public void testParseLevelWithBadObjects() {
        SampleGame game = new SampleGame();
        Level level = LevelParser.parseLevel(game, "data/levels/testing/bad.csv");
        level.update(0); // To finish adding static/dynamic objects
        // Level properties
        assertNotNull(level);
